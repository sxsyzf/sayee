 ...
 */
package com.sayee.sxsy.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.sayee.sxsy.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.sayee.sxsy.modules.sys.entity.User(null, userId)))){
